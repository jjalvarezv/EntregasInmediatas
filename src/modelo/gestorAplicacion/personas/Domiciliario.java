...
public class Domiciliario extends UsuarioRegistrado implements CalcularGanancias{
	private modelo.gestorAplicacion.gestion.Pedido pedido;
	private int estado;
	...
	public Domiciliario(String userName, String pass, String nombre, Long cc,
			modelo.gestorAplicacion.gestion.Pedido pedido, int estado) {
	...
	public void asignarPedido(modelo.gestorAplicacion.gestion.Pedido pedido) {
		this.pedido= pedido;
	}
